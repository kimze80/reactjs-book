      ...
      <div id="layout">
        ...
        <div id="menu">
          <div className="pure-menu">
            <a className="pure-menu-heading" href="ze">
              Company
            </a>

            <ul className="pure-menu-list">
              <li className="pure-menu-item">
                <a href="ze" className="pure-menu-link">
                  Home
                </a>
              </li>
              <li className="pure-menu-item">
